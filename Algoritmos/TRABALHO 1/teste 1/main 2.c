    ...
    CENTAVOSUNI =(int)CENTAVOS % 10;
       ...
       switch(UNIM){
        ...
        if (CENTAVOSUNI == 0) {
            ...
            printf(" e %d centavos", CENTAVOSUNI);
        }
...
int main(){
    //primeiro fazer o menu, depois fa�o cada fun��o e descubro como implemento a manipula��o de arquivo//
    int OPC;
    int NUM;
    do{
    printf("\t  -----------------------MENU-----------------------\n\n");
